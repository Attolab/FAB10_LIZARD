...
class DAQ_Move_SmarActMCS(DAQ_Move_base):
    ...
    is_multiaxes = True
    # we suppose to have a MCS controller with 9 channels.
    stage_names = [0, 1, 2, 3, 4, 5, 6, 7, 8]
    ...
    def ini_stage(self, controller=None):
        ...
        try:
            ...
            # The value of epsilon set the tolerance around the target position
            # within which it is considered that the target position is reached
            # Never set it below your actuator precision.
